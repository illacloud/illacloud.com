...
const stubs = {
  tailwind: fs.readFileSync(
    require.resolve('tailwindcss/stubs/simpleConfig.stub'),
    'utf8',
  ),
  postcss: fs.readFileSync(
    require.resolve('tailwindcss/stubs/defaultPostCssConfig.stub'),
    'utf8',
  ),
}
  ...
  return (tree, VFile) => {
    ...
    visit(tree, 'code', (node, index, parent) => {
      ...
      parent.children.splice(
        index,
        1,
        ...[].concat(prevals[node.meta](yaml(node.value), node)),
      )
    })
  }
}
