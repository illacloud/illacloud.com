---
title: Selecteren
metaTitle: ILLA Cloud Selecteer component
description: Geeft alle opties weer in het keuzemenu en ondersteunt 1 optie.
tagCategory: menu_select_klik
---

* * *

## <Heading hidden>Selecteer</Heading>
