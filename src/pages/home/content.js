...
import {ContentItem} from "@/pages/home/content-item";
...
function renderItem(icon, title, des, href) {
  return (
    <NextLink href={href ?? '/'}>
      <a href="/">
        <div
          className="bg-white/[0.12] w-full h-[212px] flex flex-col  items-start justify-center px-[16px] rounded-[32px]">
          {icon}
...
export function Content() {
  ...
  return (
    <div className="w-full">
      {/*page 01*/}
      <ContentItem img={require('./images/4.png').default} contentNode={<><div className="leading-[29px] sm: leading-[58px]">
        A
      ...
      {/*page 02*/}
      <ContentItem img={require('./images/2.png').default} contentNode={<> Integrate with
      ...
      {/*page 03*/}
      <ContentItem img={require('./images/1.png').default} contentNode={<> <div className="leading-[58px] ">
        Built for
      ...
      {/*page 04*/}
      <ContentItem img={require('./images/3.png').default} contentNode={<> <div className="leading-[58px] ">Real-Time</div>
      ...
      {/*page 05*/}
      <div
        className="flex flex-col items-center sm:h-[100vh] sm:overflow-y-hidden bg-black justify-center text-[48px] font-bold text-white rounded-b-[80px]"
      >
