...
desc: Visar alla alternativ i radiogruppen och stöder för att välja 1 alternativ.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/253?languages=sv&filter=basic&value=0
