---
title: Välj
metaTitle: Välj komponentdoc <unk> ILLA Cloud
desc: Visar alla alternativ i rullgardinsmenyn och stöder för att välja 1 alternativ.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/259?languages=sv&filter=basic&value=0
