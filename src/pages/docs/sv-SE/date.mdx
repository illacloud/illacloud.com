...
desc: Lär dig hur du använder datumkomponenten för att lägga till en kalenderväljare i din app och anpassa dess utseende och beteende.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/333?languages=sv&filter=basic&value=0
