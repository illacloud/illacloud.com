...
metaTitle: format@@0 Radio group Component doc ,ILLA Cloud
desc: Exibe todas as opções no grupo de rádio e suporta para selecionar 1 opção.
crowdinRepo: https://crowdin.com/multilingues/illacloud-website/253?languages=pt&filter=basic&value=0
