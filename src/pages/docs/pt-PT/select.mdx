---
title: Selecionar
metaTitle: Selecione o Documento Componente, ILLA Cloud
desc: Exibe todas as opções na caixa suspensa e suporta para selecionar 1 opção.
crowdinRepo: https://crowdin.com/multilingues/illacloud-website/259?languages=pt&filter=basic&value=0
