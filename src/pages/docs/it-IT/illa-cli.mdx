...
desc: ILLA CLI ti permette di distribuire ILLA Builder più velocemente della tua immaginazione.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/217?languages=it&filter=basic&value=0
