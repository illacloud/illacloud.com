---
title: Data Ora
metaTitle: Data Ora Componente Doc <unk> ILLA Cloud
desc: Scopri come utilizzare il componente Data Time da ILLA Cloud per consentire agli utenti di scegliere una data e un'ora da un calendario e 24 ore UI nelle vostre applicazioni.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/339?languages=it&filter=basic&value=0
...
## <h2 hidden>Che cos'è l'Ora della data?</h2>
