---
title: Tabella
metaTitle: Componente ILLA Cloud table doc
description: Visualizzare e interagire con i dati utilizzando il componente della tabella.
...
## <Heading hidden>Tabella</Heading>
