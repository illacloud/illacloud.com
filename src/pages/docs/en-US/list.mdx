...
The [List View](https://retool.com/components/list-view) component allows you to create repeatable rows of data whose look and feel are defined by you.

The List View component is similar to a [Container](https://retool.com/components/container) in that you can nest other components inside of it. You control the number of rows, which determines the number of times a component appears in a list view

<img
  src={require('@/img/docs/assemble/list.png').default}
  alt=""
/>
...
<img
  src={require('@/img/docs/assemble/list1.png').default}
  alt=""
/>
...
<img
  src={require('@/img/docs/assemble/list2.png').default}
  alt=""
/>
...
<img
  src={require('@/img/docs/assemble/list3.png').default}
  alt=""
/>
