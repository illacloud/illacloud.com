...
![list_view](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/list_review.png)
...
![list_drag](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/list_drag.png)

### Display action results in a list
...
![list_display](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/list_data.png)
...
![list_use](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/use_list_data.png)
