...
#### Create action
The process of using SQL queries is divided into the following steps:
...
#### Query Breakdown
1. Transformer: You can refine the action logic with JavaScript statements in a transformer, for example by using the filter function in JS instead of the where function in a action statement.
