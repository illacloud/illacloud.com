...
![table_column_setting](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/table_column_setting.png)
...
![table_mapped_value](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/table_mapped_value.png)
...
![table_use_data](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/table_use_data.png)

#### Update the table data
1. Use input component or other data input cpmponents to show `{{ table1.selectedRow[i].columnName }}`. 
2. Use `{{ input1.value }}` in Update actions. 
...
![table_update](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/table_update.png)

#### Insert a new row into table
1. Use `{{ input1.value }}` in insert actions. 
...
![table_insert](https://github.com/illacloud/illacloud.com/blob/main/src/img/docs/table_insert.png)
