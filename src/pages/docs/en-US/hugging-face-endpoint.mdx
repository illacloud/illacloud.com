...
<img src={require('@/img/docs/connect/hf5.gif').default} alt="" />

After the above steps are configured, the application is created and the running results are as follows.

![Powered by Whisper on Hugging Face.gif](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/e081c8df-308f-4938-9519-3d8844c101bc/Powered_by_Whisper_on_Hugging_Face.gif)
