...
Event handlers are an integral part of refining your internal tool usage logic. Any insert or action that responds to a user action has its own events that may be triggered, such as a button insert with a 'click' event, a text input box with a 'submit' event, the success of a action, and so on. Event handlers help users to trigger pre-defined instructions when events occur: you can react to a single event occurrence, or you can set up multiple event handlers and set them up as workflows to do more complex work.
...
[//]: # (<img alt="event-handler" src="https://cdn.illafamily.com/official-site%2Fdocs%2Fevent-handler-01.png" width="400" />)
...
[//]: # (<img alt="event-handler" src="https://cdn.illafamily.com/official-site%2Fdocs%2Fevent-handler-02.png" width="600" />)
...
[//]: # (<img alt="event-handler" src="https://cdn.illafamily.com/official-site%2Fdocs%2Fevent-handler-03.png" width="400" />)
