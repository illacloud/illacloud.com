...
<img alt="event-handler" src={require('@/img/official-site/event-handler-01.png').default} />
...
<img alt="event-handler" src={require('@/img/official-site/event-handler-02.png').default} />
...
<img alt="event-handler" src={require('@/img/official-site/event-handler-03.png').default} />
