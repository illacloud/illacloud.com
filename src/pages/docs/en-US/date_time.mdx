...
desc: Discover how to use the Date Time component from ILLA Cloud to enable users to pick a date and time from a calendar and 24 hours UI in your applications. 
...
| Event | Description |
| --- | --- |
| Change | When a user changes the selected date time value, perform specific action customized by users. |
