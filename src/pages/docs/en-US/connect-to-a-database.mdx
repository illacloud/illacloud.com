...
metaTitle: Connect to a Database | ILLA Cloud 
desc: Discover how to connect to a database from ILLA Cloud and access data from PostgreSQL, MySQL, TiDB, and MongoDB in your applications.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/179?languages=en&filter=basic&value=0
