...
<img src={require('@/img/docs/upload1.png').default} alt="" />
...
<img src={require('@/img/docs/upload2.gif').default} alt="" />
...
<img src={require('@/img/docs/upload3.png').default} alt="" />
...
<img src={require('@/img/docs/upload4.png').default} alt="" />
...
<img src={require('@/img/docs/upload5.gif').default} alt="" />
