...
<img
  src={require('@/img/docs/qs_1.png').default}
  alt=""
/>
...
<img
  src={require('@/img/docs/qs_2.png').default}
  alt=""
/>
...
<img
  src={require('@/img/docs/qs_3.png').default}
  alt=""
/>

1. Create a MySQL action in the App editor. Named it as action1.
