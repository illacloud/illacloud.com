...
## <Heading hidden>Radio group</Heading>
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/ba683419-f1ad-4986-bfcf-b88356b6a8e7/Untitled.png)

<img src={require('@/img/docs/assemble/radiogroup1.png').default} alt="" />
...
<img src={require('@/img/docs/assemble/radiogroup2.png').default} alt="" />
