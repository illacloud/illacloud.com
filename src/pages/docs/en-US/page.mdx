...
<img src={require('@/img/docs/assemble/page1.gif').default} alt="" />
...
<img src={require('@/img/docs/assemble/page2.png').default} alt="" />
...
<img src={require('@/img/docs/assemble/page3.png').default} alt="" />
...
<img src={require('@/img/docs/assemble/page4.png').default} alt="" />

### Set the layout of the pages

Go to the page configuration as the following steps：

<img src={require('@/img/docs/assemble/page5.png').default} alt="" />

You can use the Preset Layouts, or manually add and delete sections to set the layout. 

<img src={require('@/img/docs/assemble/page6.gif').default} alt="" />
...
<img src={require('@/img/docs/assemble/page7.png').default} alt="" />

### Connect menu and pages

Add event handlers to Menu items → set the `Action` to `Set router` → select the page and view

<img src={require('@/img/docs/assemble/page8.gif').default} alt="" />
