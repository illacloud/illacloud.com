...
<img src={require('@/img/docs/docs/assemble/multiselect1.png').default} alt="" />
...
<img src={require('@/img/docs/docs/assemble/multiselect2.png').default} alt="" />
    

<img src={require('@/img/docs/docs/assemble/multiselect3.png').default} alt="" />
