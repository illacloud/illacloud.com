...
<img src={require('@/img/docs/assemble/multiselect1.png').default} alt="" />
...
<img src={require('@/img/docs/assemble/multiselect2.png').default} alt="" />
    

<img src={require('@/img/docs/assemble/multiselect3.png').default} alt="" />
