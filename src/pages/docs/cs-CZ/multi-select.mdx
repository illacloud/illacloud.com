...
metaTitle: Vícenásobný výběr komponenty | ILLA Cloud
desc: Rozbalovací komponenta, která zobrazuje všechny možnosti, podporuje více výběrů
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/239?languages=cs&filter=basic&value=0
...
## <h2 hidden>Vícenásobný výběr</h2>
