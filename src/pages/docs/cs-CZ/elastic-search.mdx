...
desc: Použijte ILLA Cloud pro připojení a interakci s vašimi Elastic Search data. Vytvořte aplikace, které mohou provádět fulltextové vyhledávání, logování a další.
