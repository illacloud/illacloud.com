...
desc: CLI ILLA umožňuje nasazení ILLA Builder rychleji než vaše představivost.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/217?languages=cs&filter=basic&value=0
