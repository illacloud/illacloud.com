---
title: Vybrat
metaTitle: Vyberte komponentní doc | ILLA Cloud
desc: Zobrazí všechny možnosti v rozbalovacím okně a podporuje výběr 1 možnosti.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/259?languages=cs&filter=basic&value=0
