---
title: Radio gruppe
metaTitle: ILLA Cloud Radio-gruppekomponent
description: Viser alle alternativer i radio gruppen og støtter for å velge 1 valg.
tagCategory: doc_meny_radio_group_klikk
...
## <Heading hidden>Radio gruppe</Heading>

En radiokruppe, også kjent som en envalgsgruppe eller bare en radiogruppe. er en komponent som tillater brukere å velge bare ett alternativ fra en liste med forhåndsdefinerte alternativer. Hvert alternativ i gruppen representeres av en sirkulær knapp som kan velges eller desvelges av brukere. Når ett alternativ er valgt, vil et tidligere valgt alternativ i gruppen automatisk bli valgt.

Radiokrupper brukes vanligvis i skjemaer, dialogbokser og andre interaktive applikasjoner der brukerne må foreta ett enkelt valg fra et sett med alternativer. De er nyttige for å hindre feil som kan oppstå når brukere velger flere alternativer ved en feiltakelse eller forvirring. I tillegg er radioknappgrupper enkle å bruke og visuelt intuitive, noe som gjør dem populært for både designere og utviklere.
