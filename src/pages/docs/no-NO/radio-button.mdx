---
title: Radio knapp
metaTitle: Radioknapp Komponent doc ∙ILLA Cloud
desc: Vise alle alternativer på radioknapper og støtte for å velge 1 alternativ.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/251?languages=no&filter=basic&value=0
