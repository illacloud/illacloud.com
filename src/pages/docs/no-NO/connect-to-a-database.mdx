...
metaTitle: Koble til en Database εILLA Cloud
desc: Oppdag hvordan du kan koble til en database fra ILLA Cloud og få tilgang til data fra PostgreSQL, MySQL, TiDB og MongoDB i dine programmer.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/179?languages=no&filter=basic&value=0
...
## <h2 hidden>Koble til en database</h2>
