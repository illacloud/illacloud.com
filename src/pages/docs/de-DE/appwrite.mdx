...
Wir haben eine Appwrite-Ressource erstellt. Wir können die Aktion hinzufügen, indem wir Appwrite aus der Aktionsliste auswählen und die **`Erstelle Aktion`** Schaltfläche auswählen.
