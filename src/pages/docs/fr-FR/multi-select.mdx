...
metaTitle: Composant à sélection multiple | Nuage ILLA
desc: Un composant déroulant qui affiche toutes les options, supporte plusieurs sélections
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/239?languages=fr&filter=basic&value=0
...
## <h2 hidden>Sélection multiple</h2>
