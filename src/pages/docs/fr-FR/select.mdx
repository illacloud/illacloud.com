---
title: Sélectionner
metaTitle: Sélectionnez le composant doc | ILLA Cloud
desc: Affiche toutes les options dans la liste déroulante et supporte de sélectionner 1 option.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/259?languages=fr&filter=basic&value=0
