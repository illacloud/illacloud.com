---
title: Supabase DB
metaTitle: Suprimir documento de integración DB | Nube ILLA
desc: Conectar a la instancia de Supabase y mostrar datos de Supabase DB en los componentes
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/265?languages=es&filter=basic&value=0
