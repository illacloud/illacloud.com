...
metaTitle: Doc de componente del botón de radio | Nube de ILLA
desc: Mostrar todas las opciones en los botones de radio y soporte para seleccionar una opción.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/251?languages=es&filter=basic&value=0
