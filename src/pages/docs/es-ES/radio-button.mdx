...
metaTitle: Componente del botón de radio
description: Mostrar todas las opciones en los botones de radio y soporte para seleccionar una opción.
tagCategory: doc_menú_botón_radio_clic
...
## <Heading hidden>Botón de radio</Heading>
