...
metaTitle: Documento de componente de grupo de radio | Nube de ILLA
desc: Muestra todas las opciones en el grupo de radio y soporta seleccionar una opción.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/253?languages=es&filter=basic&value=0
