---
title: Seleccionar
metaTitle: Componente de selección de nube ILLA
description: Muestra todas las opciones en el cuadro desplegable y soporta seleccionar una opción.
tagCategory: doc_menú_seleccionar_clic
...
## <Heading hidden>Seleccionar</Heading>
