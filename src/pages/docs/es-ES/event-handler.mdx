...
metaTitle: Documento del controlador de eventos | Nube ILLA
desc: Los manejadores de eventos son una parte integral de refinar la lógica de uso de la herramienta interna
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/205?languages=es&filter=basic&value=0
