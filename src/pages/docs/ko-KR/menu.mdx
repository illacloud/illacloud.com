...
| 속성       | 설명                                                                                        |
| -------- | ----------------------------------------------------------------------------------------- |
| 메뉴       | actual content and options displayed within the menu component                            |
| 숨다       | hides the form component from the user's view                                             |
| 주문하다     | the orientation or layout of the menu component                                           |
| 맞추다      | the positioning or alignment of the menu component within its container or parent element |
...
| 숨다              | whether the menu component is visible or hidden                                                               |
...
| 안건              | collection of menu items or options available within the menu component                                       |
