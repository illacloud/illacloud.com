...
| 속성                        | 설명                                                                                                     |
| ------------------------- | ------------------------------------------------------------------------------------------------------ |
| 이벤트 핸들러                   | detecting and responding to specific user actions or events, such as clicks, keypresses, value changes |
| 마스크를 클릭하여 모달을 닫습니다.       | whether clicking on the background overlay or mask of the modal will close the modal window            |
| 제목 영역 표시                  | whether the component should display a header or title section                                         |
| 디스플레이 작동 영역               | whether the component should display a footer section                                                  |
...
| 테두리 폭                     | thickness or width of the border surrounding a modal component                                         |
| 배경                        | defines the color or image that fills the content area of a modal component                            |
