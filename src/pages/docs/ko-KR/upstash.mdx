...
| 포트         | 필수 | The server host's port number that you should use to connect. If you don't specify a port, default port is '6379'. |
| 비밀번호       | 필수 | Use this password for authentication.                                                                              |
| SSL option | 필수 | whether to enable the SSL (recommend to enable)                                                                    |
