...
| 포트         | 필수    | The server host's port number that you should use to connect.                                     |
| 데이터 베이스    | 필수    | The name of the database                                                                          |
| 사용자 이름     | 필수    | the username you wish to use when logging in to the Elastic Search server.                        |
...
| 속성       | 필수    | 설명                                                      |
| -------- | ----- | ------------------------------------------------------- |
| 본체       | 선택 과목 | a JSON document that contains the data to be inserted   |
| 인덱스      | 선택 과목 | name of the index where the document should be inserted |
...
| 속성         | 필수    | 설명                                                  |
| ---------- | ----- | --------------------------------------------------- |
| 본체         | 선택 과목 | The new value to be assigned to the field.          |
| 인덱스        | 선택 과목 | The name of the index where the document is stored. |
| ID         | 선택 과목 | The unique identifier for the document.             |
...
| 속성       | 필수    | 설명                                                                   |
| -------- | ----- | -------------------------------------------------------------------- |
| 질문       | 선택 과목 | specify the search query that is used to match documents in an index |
| 인덱스      | 선택 과목 | specify the name of the index or indices that should be searched     |
