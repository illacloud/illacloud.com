...
| 속성                  | 설명                                                                                                                                                    |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| 컨테이너와 연결되어 있습니까?    | link the Tabs component to a specific container, enabling seamless navigation between tabs and the associated content.                                |
| 이벤트 핸들러             | detecting and responding to specific user actions or events, such as clicks, keypresses, or value change.                                             |
| 장애가 있는              | disable specific tabs, preventing users from interacting with them                                                                                    |
| 힌트                  | additional information or context about each tab                                                                                                      |
| 형세                  | offers different layout options, allowing you to arrange the tabs horizontally or vertically based on your design preferences or the available space. |
| 맞추다                 | align the Tabs component to different positions within its parent container, such as left, center, or right alignment                                 |
| 숨다                  | hide specific tabs programmatically.                                                                                                                  |
...
| Property name         | 설명                                                                                                               |
| --------------------- | ---------------------------------------------------------------------------------------------------------------- |
| 맞추다                   | alignment of the tabs within the component, such as left, center, or right alignment                             |
...
| 숨다                    | boolean value that determines whether the tabs component is visible or hidden                                    |
