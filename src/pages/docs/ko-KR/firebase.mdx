...
| Firebase Database URL | 선택 과목 | the endpoint or URL where the Firebase Realtime Database is hosted                             |
| Firestore Project ID  | 선택 과목 | a unique identifier assigned to each Firebase project that uses the Firestore database service |
| 개인 키                  | 필수    | a security credential used for authenticating and accessing Firebase services programmatically |
...
| 속성         | 필수 | 설명                                                                                                        |
| ---------- | -- | --------------------------------------------------------------------------------------------------------- |
| UID        | 필수 | "User Identifier." It is a unique identifier assigned to each user in the Firebase authentication system. |
...
| 속성       | 필수 | 설명                                                                 |
| -------- | -- | ------------------------------------------------------------------ |
| 이메일      | 필수 | the registered email associated with the user you want to retrieve |
...
| 속성   | 필수 | 설명                                                                        |
| ---- | -- | ------------------------------------------------------------------------- |
| 전화번호 | 필수 | the registered phone number associated with the user you want to retrieve |
...
| 속성          | 필수 | 설명                                         |
| ----------- | -- | ------------------------------------------ |
| User object | 필수 | an object that contains user's information |
...
| 속성              | 필수    | 설명                                                                             |
| --------------- | ----- | ------------------------------------------------------------------------------ |
| 리스트 길이          | 선택 과목 | number of users you want to retrieve in a single request                       |
| Next page token | 선택 과목 | pagination when there are more users than can be returned in a single response |
...
| 속성                 | 필수    | 설명                                                             |
| ------------------ | ----- | -------------------------------------------------------------- |
| 수집                 | 필수    | can use dropdown to select or use a raw id                     |
| where              | 필수    | add conditions to your query                                   |
| Limit              | 선택 과목 | limit the number of documents returned by the query.           |
| Order by           | 선택 과목 | specify the field by which you want to order the query results |
| Ordering direction | 선택 과목 | the direction of the ordering in the query results             |
...
| 속성      | 필수    | 설명                                                                                                                            |
| ------- | ----- | ----------------------------------------------------------------------------------------------------------------------------- |
| 수집      | 필수    | specifies the name of the collection in which you want to insert the document. can use the dropdown to select or use a raw id |
| 문서 ID   | 선택 과목 | specify a custom identifier for the document being inserted                                                                   |
| 값       | 필수    | the actual data that you want to insert into the document                                                                     |
...
| 속성      | 필수    | 설명                                                                                                                            |
| ------- | ----- | ----------------------------------------------------------------------------------------------------------------------------- |
| 수집      | 필수    | specifies the name of the collection in which you want to update the document. can use the dropdown to select or use a raw id |
| 문서 ID   | 선택 과목 | specify a custom identifier for the document being updated                                                                    |
| 값       | 필수    | the actual data that you want to update into the document                                                                     |
...
| 속성    | 필수    | 설명                                                                                                                              |
| ----- | ----- | ------------------------------------------------------------------------------------------------------------------------------- |
| 수집    | 필수    | specifies the name of the collection in which you want to retrieve the document. can use the dropdown to select or use a raw id |
| 문서 ID | 선택 과목 | specify a custom identifier for the document being retrieved                                                                    |
...
| 속성                 | 필수    | 설명                                                           |
| ------------------ | ----- | ------------------------------------------------------------ |
| Parent Document ID | 선택 과목 | specify a custom identifier for the document being retrieved |
...
| 속성           | 필수 | 설명                                                  |
| ------------ | -- | --------------------------------------------------- |
| Database ref | 필수 | a reference to a specific location in the database. |
...
| ------------- | -- | ---------------------------------------------------------------------------------------------------------- |
| Database ref  | 필수 | a reference to a specific location in the database.                                                        |
| Object to set | 필수 | object contains the data that we want to write to the database, including the name, age, and email fields. |
...
| ----------- | -- | ----------------------------------------------------------------------------------------------------------- |
| UID         | 필수 | "User Identifier." It is a unique identifier assigned to each user in the Firebase authentication system.   |
| User object | 필수 | object contains the data that we want to update to the database, including the name, age, and email fields. |
...
| ------------- | -- | ----------------------------------------------------------------------------------------------------------- |
| Database ref  | 필수 | a reference to a specific location in the database.                                                         |
| Object to set | 필수 | object contains the data that we want to update to the database, including the name, age, and email fields. |
