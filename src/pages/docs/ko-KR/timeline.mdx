...
| 속성      | 설명                                                                                    |
| ------- | ------------------------------------------------------------------------------------- |
| 안건      | the collection of individual events or data points that are displayed on the timeline |
| 주문하다    | the orientation or layout of the timeline component (horizontal or vertical)          |
| 보류 중    | the status of an item in the timeline                                                 |
| 높은      | vertical size or height of the timeline component                                     |
| 숨다      | whether the timeline component is visible or hidden                                   |
...
| Property name   | 설명                                                                                                  |
| --------------- | --------------------------------------------------------------------------------------------------- |
| 주문하다            | orientation or layout of the timeline                                                               |
...
| 숨다              | whether the timeline component is visible or hidden                                                 |
| 안건              | the collection of individual events or data points displayed on the timeline                        |
| 보류 중            | the status of an item in the timeline                                                               |
