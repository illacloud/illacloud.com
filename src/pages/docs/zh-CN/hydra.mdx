...
desc: 使用 ILLA Cloud访问并使用您的 Hydra 数据。 创建可以查询、操作和显示数据的应用。 创建可以查询、操作和显示数据的应用。 创建可以查询、操作和显示数据的应用。 创建可以查询、操作和显示数据的应用。 创建可以查询、操作和显示数据的应用。
...
| 端口                 | 必填  | 您应该使用服务器主机的端口号进行连接。 如果您没有指定端口，默认端口为“5432”。 如果您没有指定端口，默认端口为“5432”。 如果您没有指定端口，默认端口为“5432”。 如果您没有指定端口，默认端口为“5432”。 如果您没有指定端口，默认端口为“5432”。                                                                                                                 |
| 数据库                | 必填  | 数据库名称                                                                                                                                                                                                                                                  |
