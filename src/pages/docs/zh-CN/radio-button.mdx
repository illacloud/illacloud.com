---
title: 单选按钮
metaTitle: 单选按钮组件 doc | ILLA Cloud
desc: 通过单选按钮，展示所有选项，并允许选择其中一项
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/251?languages=zhcn&filter=basic&value=0
