...
ILLA CLI安装完成后，你可以通过其进行本地化部署和[ILLA云服务部署](https://cloud.illacloud.com/).

快速部署

```
> illa 部署 --self --port=10000
```
...
## 可将MOUNT_PATH设置为自定义的ILLA Builder mount路径, 如若不填其值为系统用户目录下的.illa-builder文件夹路径
