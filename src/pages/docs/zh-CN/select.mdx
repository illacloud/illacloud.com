---
title: 下拉选择（Select）
metaTitle: 选择组件doc | ILLA Cloud
desc: 通过下拉框展示所有选项，允许选择其中一项
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/259?languages=zhcn&filter=basic&value=0
