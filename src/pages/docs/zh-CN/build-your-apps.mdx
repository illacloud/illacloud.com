---
title: 搭建APP
metaTitle: 构建您的应用程序 | ILLA Cloud
desc: 探索如何使用 ILLA Cloud的UI 组件库来构建应用程序
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/169?languages=zhcn&filter=basic&value=0
...
组件是 ILLA 的重要组成部分，它们的功能类似于 React 组件，因为它们可以接受属性并具有内部状态。\
