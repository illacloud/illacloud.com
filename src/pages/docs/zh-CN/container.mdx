---
title: 容器（Container）
metaTitle: 容器组件doc | ILLA Cloud
desc: 学习如何使用 ILLA Container 来将组件分组
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/185?languages=zhcn&filter=basic&value=0
