...
在Hugging Face中，通过公共API可以访问超过130,000个机器学习模型，您可以在https://huggingface.co/models 中免费使用和测试。此外，如果您需要生产场景的解决方案，可以使用Hugging Face的推理终端点，了解更多关于推理终端点的信息：https://huggingface.co/docs/inference-endpoints/index。
...
我们以[deepset/roberta-base-squad2](https://huggingface.co/deepset/roberta-base-squad2） 为例。进入详细页面>单击“部署”>单击“推理API”
