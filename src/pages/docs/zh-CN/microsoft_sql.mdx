...
| 端口                | 必填  | 您应该使用服务器主机的端口号进行连接。 如果您没有指定端口，默认端口是 '1433'。                                                               |
| 数据库               | 必填  | 数据库名称                                                                                                     |
...
| 属性       | 描述                                                                                                                                                                                                                                        |
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 配置类型     | 您用来连接到MS SQL Server 数据库的配置类型：SQL 和 Bulk 插入 对于SQL模式，您可以使用 SQL 查询。 对于批量插入模式，您可以将数据插入一个选定的表格，格式为 {}。[{x:a, y:b}， … ] }}                                                                                                                      |
