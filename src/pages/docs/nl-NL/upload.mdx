...
| Formulier gegevenssleutel                | Het instellen van een sleutel voor het component Het instellen van een sleutel voor het component Het instellen van een sleutel voor het component Na het toevoegen van dit component aan een formulier, zal deze sleutel worden gebruikt om de gegevens van deze component te identificeren bij het verzenden van het formulier.                                      |
