---
title: Multiselect
metaTitle: ILLA Cloud Multi-select onderdeel
description: Een drop-down component die alle opties weergeeft, ondersteunt meerdere selecties
tagCategory: menu_multi_select_klik
---
