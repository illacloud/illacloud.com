---
title: Radio groep
metaTitle: Oprichtingsgroep Component doc - ILLA Cloud
desc: Toont alle opties van de radiogroep en ondersteunt 1 optie.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/253?languages=nl&filter=basic&value=0
...
## <h2 hidden>radiogroep</h2>

Een radiogroep, ook bekend als een enkelvoudige groep of gewoon een radiogroep. is een component waarmee gebruikers slechts één optie kunnen selecteren uit een lijst met vooraf gedefinieerde opties. Elke optie in de groep wordt weergegeven door een cirkelvormige knop die kan worden geselecteerd of gedeselecteerd door gebruikers. Wanneer een optie is geselecteerd, wordt elke eerder geselecteerde optie in de groep automatisch gedeselecteerd.

Radio groepen worden vaak gebruikt in webformulieren, dialoogvenster en andere interactieve toepassingen waarbij gebruikers een enkele keuze moeten maken uit een set opties. Ze zijn nuttig voor het voorkomen van fouten die kunnen optreden wanneer gebruikers meerdere opties per ongeluk selecteren of verwarren. Bovendien zijn radioknopgroepen makkelijk te gebruiken en visueel intuïtief, waardoor ze een populaire keuze zijn voor ontwerpers en ontwikkelaars.
...
We ondersteunen het luisteren naar het `onChange` evenement van de radiogroep. 

Wanneer de geselecteerde optie verandert, kan het een gespecificeerde actie starten. Dit betekent dat wanneer een gebruiker een andere optie selecteert van een radiogroep, een bepaalde actie kan worden uitgevoerd op basis van de geselecteerde optie. Bijvoorbeeld in een webformulier, het selecteren van een andere optie kan de weergave van verschillende formuliervelden of het indienen van het formulier naar een andere bestemming. Op deze manier kan de door de gebruiker geselecteerde optie het gedrag van de software of webapplicatie die ze gebruiken beïnvloeden. De mogelijkheid om specifieke acties te activeren op basis van gebruikersinvoer is een belangrijk aspect van interactief softwareontwerp en kan de bruikbaarheid en functionaliteit van de software verbeteren.
