---
title: Selecteren
metaTitle: Selecteer Component doc × ILLA Cloud
desc: Geeft alle opties weer in het keuzemenu en ondersteunt 1 optie.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/259?languages=nl&filter=basic&value=0
...
## <h2 hidden>Selecteer</h2>

Een selecte component wordt vaak gebruikt om gebruikers met een lijst met opties in een uitklapmenu formaat te presenteren. De gebruiker kan slechts één optie tegelijk uit de keuzelijst selecteren.

Het dropdown onderdeel met enkelvoudige selectie bestaat meestal uit een tekstlabel en een dropdown pijl pictogram. welke wanneer geklikt of geklikt wordt, opent een lijst met opties voor de gebruiker om uit te kiezen. Zodra de gebruiker een optie selecteert, sluit het dropdown menu en wordt de geselecteerde optie weergegeven in het component.

Deze component wordt vaak gebruikt in formulieren, enquêtes, en andere scenario's voor gegevensinvoer waarbij een gebruiker een optie moet selecteren uit een vooraf gedefinieerde set keuzes. Het biedt een compacte en intuïtieve manier om een lijst met opties te presenteren zonder te veel scherm onroerend goed te nemen of de gebruiker te overreden met te veel opties in één keer.
...
We ondersteunen het luisteren naar het `onChange` evenement van het select component. 

Wanneer de geselecteerde optie verandert, kan het een gespecificeerde actie starten. Dit betekent dat wanneer een gebruiker een andere optie selecteert uit een select component, een bepaalde actie kan worden uitgevoerd op basis van de geselecteerde optie. Bijvoorbeeld in een webformulier, het selecteren van een andere optie kan de weergave van verschillende formuliervelden of het indienen van het formulier naar een andere bestemming. Op deze manier kan de door de gebruiker geselecteerde optie het gedrag van de software of webapplicatie die ze gebruiken beïnvloeden. De mogelijkheid om specifieke acties te activeren op basis van gebruikersinvoer is een belangrijk aspect van interactief softwareontwerp en kan de bruikbaarheid en functionaliteit van de software verbeteren.
