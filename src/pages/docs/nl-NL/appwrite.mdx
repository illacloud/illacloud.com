...
We hebben een Appwrite bron gemaakt, we kunnen de actie toevoegen door Appwrite uit de actielijst te selecteren en te kiezen voor de **`Create action`** knop.
