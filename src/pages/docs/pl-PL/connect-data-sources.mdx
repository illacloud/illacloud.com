...
metaTitle: Połącz ze źródłami danych | ILLA Cloud
desc: Dowiedz się, jak połączyć się ze źródłem danych i zadzwonić do niego w swoim konstruktorze ILLA, aby uzyskać dostęp do danych i manipulować nimi w aplikacjach.
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/177?languages=pl&filter=basic&value=0
...
## <h2 hidden>Połącz ze swoimi źródłami danych (Action)</h2>
