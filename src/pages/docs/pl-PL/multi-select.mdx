...
metaTitle: Komponent wielokrotnego wyboru | Chmura ILLA
desc: Komponent rozwijany, który wyświetla wszystkie opcje, obsługuje wiele opcji
crowdinRepo: https://crowdin.com/multilingues/illacloud-website/239?languages=pl&filter=basic&value=0
...
## <h2 hidden>Wybór wielokrotny</h2>
