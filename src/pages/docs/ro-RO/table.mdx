---
title: Tabel
metaTitle: Componenta tabel DOc <unk> ILLA Cloud
desc: Afișează și interacționează cu datele folosind componenta Tabel.
crowdinRepo: https://crowdin.com/multilingual/illacloud-site/267?languages=ro&filter=basic&value=0
