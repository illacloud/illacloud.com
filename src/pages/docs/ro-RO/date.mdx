...
desc: Învățați cum să utilizați componenta dată pentru a adăuga un selector de calendar în aplicație și personalizați aspectul și comportamentul acesteia.
crowdinRepo: https://crowdin.com/multilingual/illacloud-site/333?languages=ro&filter=basic&value=0
