---
title: イベントハンドラ：
metaTitle: イベントハンドラコンポーネントdoc | ILLA Cloud
desc: イベントハンドラーは、内部ツールの使用ロジックを改良するための不可欠な部分です
crowdinRepo: https://crowdin.com/multilingual/illacloud-website/205?languages=ja&filter=basic&value=0
