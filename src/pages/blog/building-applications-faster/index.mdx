...
export const meta = {
  title: `Building Applications Faster with TiDB and ILLA Builder`,
...
Now that you have a free TiDB Cluster, it’s time to connect it to the [ILLA Builder](https://github.com/illa-family/illa-builder).
