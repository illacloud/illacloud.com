...
export const meta = {
  ...
  description: `Retool is a low-code internal tools builder that has been gaining popularity in the past few years. However, there are many other options available. Here are seven of the best!`,
