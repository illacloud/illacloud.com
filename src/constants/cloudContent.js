export const CloudContent = {
  ...
  chooseIlla: {
    title: 'why-illa.title',
    items: [
      {
        label: 'why-illa.AI.title',
        desc: 'why-illa.AI.desc'
      },
      {
        label: 'why-illa.teamwork.title',
        desc: 'why-illa.teamwork.desc'
      },
      {
        label: 'why-illa.anyone-can-use.title',
        desc: 'why-illa.anyone-can-use.desc'
      },
      {
        label: 'why-illa.deploy.title',
        desc: 'why-illa.deploy.desc'
      },
      {
        label: 'why-illa.unlimited-viewer.title',
        desc: 'why-illa.unlimited-viewer.desc'
      }
    ]
  },
  benefits: {
    ...
    items: [
      {
        label: 'benefits.rapid.title',
        desc: 'benefits.rapid.desc'
      },
      {
        label: 'benefits.no-skill.title',
        desc: 'benefits.no-skill.desc'
      },
      {
        label: 'benefits.cost-reduce.title',
        desc: 'benefits.cost-reduce.desc'
      }
    ]
  },
}
