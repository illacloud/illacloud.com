...
export function DocumentationHeader(props){
  ...
  return <Head>
    ...
    <meta
      ...
      name="og:image"
      property="og:image"
      content={`https://illa.cloud${meta.image??`https://illa.cloud${
    ...
    <meta name="twitter:title" content={`${meta.metaTitle||meta.title} – ILLA`} />
    <meta name="twitter:description" content={meta.description ?? meta.desc} />
    {meta.image ? (
      <>
