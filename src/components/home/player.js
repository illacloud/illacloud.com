  ...
  return (
    ...
    >
      ...
      <video className="w-full bg-blue-100" controls autoPlay>
        ...
        <object data="https://cdn.illafamily.com/official-site%2Fvideo-intro.mp4" width="320" height="240">
          <embed width="320" height="240" src="https://cdn.illafamily.com/official-site%2Fvideo-intro.mp4" />
        </object>
      </video>
    </div>
  )
