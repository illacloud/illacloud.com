...
export const LanguageSelect = ({ buttonColorChange = true }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          'max-h-[160px] overflow-y-auto text-[14px] transition-height duration-200 absolute top-[48px] flex flex-col items-center  w-[121px] rounded-[8px] shadow-[0px_2px_16px_0px_rgba(0,0,0,0.16)]',
          {
