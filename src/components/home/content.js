...
export function Content() {
  ...
  return (
    <div className="w-full">
      {/*page 01*/}
      <ContentItem img={require('@/img/home/4.png').default} contentNode={<><div className="leading-[29px] sm:leading-[58px]">
        A
      ...
      {/*page 02*/}
      <ContentItem img={require('@/img/home/2.png').default} contentNode={<> Integrate with
      ...
      {/*page 03*/}
      <ContentItem img={require('@/img/home/1.png').default} contentNode={<> <div className="leading-[58px] ">
        Built for
      ...
      {/*page 04*/}
      <ContentItem img={require('@/img/home/3.png').default} contentNode={<> <div className="leading-[58px] ">Real-Time</div>
