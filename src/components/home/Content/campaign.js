    ...
    <Link href="/hacktoberfest2023">
      ...
      >
        <div className="flex flex-row items-center gap-[8px] xl:gap-[16px]">
          ...
          <span>
            <span className='inline-block xl:hidden'>{t('bottom.banner.title.mobile')}</span>
            <span className='hidden xl:inline-block'>{t('bottom.banner.title.pc')}</span>
          </span>
        </div>
        <span>
          <span className="hidden xl:inline-block">{t('bottom.banner.button')}</span>
