...
构建全部内置图像并在您的机器上用 k8 运行它。 您可以在 [scripts]中查看脚本文件(https://github.com/illacloud/damy-illa-manualy/blob/main/kubernetes/scripts) 以了解更多详情。
